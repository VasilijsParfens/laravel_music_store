...
<div class="flex items-center justify-center h-54vh mt-8 mb-8">
    <div class="relative">
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex gap-x-20">
            ...
            <button class="bg-white w-64 h-12 rounded-md border border-black inline font-martian hover:bg-slate-200 ease-in-out duration-200" onclick="window.location.href='./product_categories/digital.html'"></button>
        </div>
    </div>
</div>
...
<div class="grid gap-x-0.5 gap-y-4 grid-cols-3 mt-6">
    ...
    <div class="flex justify-center">
        <a href="/albums/{{$album->id}}">
            <div class="bg-slate-100 rounded-lg p-3 border-2 border-slate-500">
