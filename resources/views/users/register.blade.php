    ...
    <form method="POST" action="/users">
        ...
        <div class="h-screen flex flex-col items-center justify-center"> <!-- Added w-full and md:w-96 for max-width -->
            <div class="name-input">
                <label for="name" class="inline-block text-xl mb-3"> Full name </label>
            ...
            <div class="confirm-password">
                <label for="password" class="inline-block text-xl mb-3">Confirm password</label>
                <input class="w-80 h-12 border-2 border-gray-400 rounded-md px-4 py-2 font-martian text-lg text-center mt-8" placeholder="Password" type="password" name="password_confirmation" value="{{old('password_confirmation')}}">
